...
::OEmbed::Providers.register(::OEmbed::Providers::Instagram, ::OEmbed::Providers::Slideshare, ::OEmbed::Providers::Yfrog, ::OEmbed::Providers::MlgTv, ::OEmbed::Providers::SoundCloud)
...
module Jekyll
  class OEmbed < Liquid::Tag
    ...
    def render(context)
      ...
      # oembed look up
      result = ::OEmbed::Providers.get(url.strip!, format: :json)
